          ...
          <View style={styles.borderContainer}>
            ...
            <View style={[styles.step1Wrapper, styles.wrapperSpaceBlock]}>
              <Text style={styles.stepDetail}>
                ...
                pan over low heat. Cook, stirring, for 2-3 minutes or until
                butter and chocolate melt and mixture is smooth. {"\n"}
            ...
            <View style={[styles.step1Wrapper, styles.wrapperSpaceBlock]}>
              <Text style={styles.stepDetail}>
                ...
                balloon whisk to gently fold the flour into the chocolate
                mixture. Add the egg and stir to combine.
              </Text>
            </View>
            <View style={[styles.step1Wrapper, styles.wrapperSpaceBlock]}>
              <Text style={styles.step}>Step 3:</Text>
